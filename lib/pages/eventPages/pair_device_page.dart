...
class PairDevicePage extends GetView<PairDevicePageController> {
  ...
  Widget get findButton => Obx(() => GestureDetector(
  ...
  Widget get selectButtonRow => Obx(() => Padding(
        ...
        child: Row(
          ...
          children: [
            plugButtons(
                ...
                (controller.buttonType.value == 1) ? true : false,
                () => controller.changeButtonValue(1)),
            plugButtons(
                "Plug",
                "assets/images/plug_icon_a_small.png",
                (controller.buttonType.value == 2) ? true : false,
                () => controller.changeButtonValue(2)),
            plugButtons(
                "Other",
                "assets/images/plug_icon_other_small.png",
                (controller.buttonType.value == 3) ? true : false,
                () => controller.changeButtonValue(3)),
          ],
        ),
      ));

  Widget plugButtons(
      String title, String path, bool onActive, Function()? onTap) {
